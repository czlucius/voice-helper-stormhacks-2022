...
const run = async () => {
  if (isRecording) { 
    ...
    const response = await fetch('https://help-banking.herokuapp.com/'); // get temp session token from server.js (backend)
...
rxns.set(
  ...
  new RxnTemplate(
    "You will be redirected to a support page explaining how to deposit a cheque/check.",
    (text) => {
...
rxns.set(
  ...
  new RxnTemplate(
    "You can visit support page of a bank. You will be redirected shortly.",
    (text) => {
